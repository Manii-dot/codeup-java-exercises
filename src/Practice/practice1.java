...
//    create and checkout to a new branch called my-solution
...
//
//    add a Song class with the following...
//
...
//    add a Album class with the following...
//
...
//    add a Playable interface with the following...
//
...
//    add an abstract Player class that implements the Playable interface (not it's methods, however) and include the following...
//
...
//    add a LyricsPlayer class that extends Player and includes the following...
//
