...
//         */
//
//        Map<String, String> marcoUsers = new HashMap<>();
//        marcoUsers.put("Shanshun", "su");
//        marcoUsers.put("Nathan", "Nate");
//        marcoUsers.put("Salim", "Slim");
//        marcoUsers.put("Sergio", "badakong");
//        marcoUsers.put("Roland", "pointing Monkey");
//        System.out.println(marcoUsers);
//
//
//
//
