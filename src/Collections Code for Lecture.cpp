...
//        System.out.println(numbers.get(0));
        ...
        ArrayList<String> marcoClassMate = new ArrayList<>();
        marcoClassMate.add("Nathan");
        marcoClassMate.add("Salim");
        marcoClassMate.add("Shan");

        String Nathan = marcoClassMate.get(0);
        String Nathan = marcoClassMate.get(1);
        String Nathan = marcoClassMate.get(2);
        System.out.println(marcoClassMate.get(0));
        System.out.println(marcoClassMate.get(1));
        System.out.println(marcoClassMate.get(2));
