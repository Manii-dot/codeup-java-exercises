...
public class ArraysLec_handout {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println("sidesArray[6] = " + sidesArray[6]);// this array will show an error for being out of bounds
...
String[] cohorts = {"Marci", "Obreon", "Neptune", "Polaris"};
System.out.println("Hey " + cohorts[0]+ "students the upcoming cohort will be coming up");
        ...
        myPets[0] = "Fluffy";
        myPets[1] = "Spot";
        //OR: String[] myPets = {"Fluffy", "Spot"}. System.out.print(myPets[0]) // Fluffy
        ...
        for(int i =0; i < cohorts.length; i++){
            System.out.println("Codeup cohorts are "+cohorts[i]);
        }
...
System.out.println();
        for(String cohort : cohorts){//for (dataType singular : arrName){do some stuff }
            System.out.println("Codeup runs a few cohorts at a time and one of the one are "+cohort);
        }
...
//
        ...
        System.out.println("Arrays.binarySearch(cohorts, \"Polaris\") = " + Arrays.binarySearch(cohorts, "Deimos"));
